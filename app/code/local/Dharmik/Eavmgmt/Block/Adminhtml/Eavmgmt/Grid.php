...
class Dharmik_Eavmgmt_Block_Adminhtml_Eavmgmt_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
   ...
   protected function _prepareCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('entity_type_code', array(
            'header'=>Mage::helper('eavmgmt')->__('Entity Type Code'),
            'sortable'=>true,
        ...
        $this->addColumn('frontend_input', array(
            'header'=>Mage::helper('eavmgmt')->__('Frontend Input'),
            'sortable'=>true,
        ...
        $this->addColumn('backend_input', array(
            'header'=>Mage::helper('eavmgmt')->__('Backend Input'),
            'sortable'=>true,
            'index'=>'backend_input'
        ));
        ...
        $this->addColumn('action',
            array(
                ...
                'type'      => 'action',
                'getter'    => 'getId',
                'renderer'  => 'Dharmik_Eavmgmt_Block_Adminhtml_Eavmgmt_Csv_ShowOption',
        ));
